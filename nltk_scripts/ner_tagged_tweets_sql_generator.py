...
reader = nltk.corpus.ConllCorpusReader('/Users/stephan/nltk_data/corpora/twitter/tweets_ner_tagged','.*\.txt', columntypes=["chunk", "words", "pos", "ne"])
#clean the input from *
sent = []
tagged = []
for sents in reader.sents():
  print sents
#   thisSent = []
#   thisTagged = []
#   flag = False
